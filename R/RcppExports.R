...
RcppEntropy <- function(vec, k = 3L, base = 10, L1norm = TRUE, NA_rm = FALSE) {
    .Call(`_spEDM_RcppEntropy`, vec, k, base, L1norm, NA_rm)
}

RcppJoinEntropy <- function(mat, k = 3L, base = 10, L1norm = TRUE, NA_rm = FALSE) {
    .Call(`_spEDM_RcppJoinEntropy`, mat, k, base, L1norm, NA_rm)
}

RcppMutualInformation <- function(mat, k = 3L, alg = 1L, normalize = TRUE, L1norm = TRUE, NA_rm = FALSE) {
    .Call(`_spEDM_RcppMutualInformation`, mat, k, alg, normalize, L1norm, NA_rm)
}

...
RcppGCCM4Grid <- function(xMatrix, yMatrix, lib_sizes, pred, E, tau = 1L, b = 0L, progressbar = TRUE) {
...
RcppGCCM4Lattice <- function(x, y, nb, libsizes, E, tau = 1L, b = 0L, progressbar = TRUE) {

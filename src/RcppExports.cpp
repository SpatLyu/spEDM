...
// RcppSignificance
double RcppSignificance(double r, int n, int k);
RcppExport SEXP _spEDM_RcppSignificance(SEXP rSEXP, SEXP nSEXP, SEXP kSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(RcppSignificance(r, n, k));
    return rcpp_result_gen;
END_RCPP
}
// RcppConfidence
Rcpp::NumericVector RcppConfidence(double r, int n, int k, double level);
RcppExport SEXP _spEDM_RcppConfidence(SEXP rSEXP, SEXP nSEXP, SEXP kSEXP, SEXP levelSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type r(rSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(RcppConfidence(r, n, k, level));
    return rcpp_result_gen;
END_RCPP
}
// RcppLinearTrendRM
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_spEDM_RcppSignificance", (DL_FUNC) &_spEDM_RcppSignificance, 3},
    {"_spEDM_RcppConfidence", (DL_FUNC) &_spEDM_RcppConfidence, 4},

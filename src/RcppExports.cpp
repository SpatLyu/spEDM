...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(RcppGCCM4Grid(xMatrix, yMatrix, libsizes, lib, pred, E, tau, b, simplex, theta, threads, parallel_level, style, stack, dist_metric, dist_average, single_sig, progressbar));
    return rcpp_result_gen;
END_RCPP
}
// RcppSCPCM4Grid
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type single_sig(single_sigSEXP);
    Rcpp::traits::input_parameter< bool >::type progressbar(progressbarSEXP);
    rcpp_result_gen = Rcpp::wrap(RcppSCPCM4Grid(xMatrix, yMatrix, zMatrix, libsizes, lib, pred, E, tau, b, simplex, theta, threads, parallel_level, cumulate, style, stack, dist_metric, dist_average, single_sig, progressbar));
    return rcpp_result_gen;
END_RCPP
}
// RcppGCMC4Grid
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_spEDM_RcppGCCM4Grid", (DL_FUNC) &_spEDM_RcppGCCM4Grid, 18},
    {"_spEDM_RcppSCPCM4Grid", (DL_FUNC) &_spEDM_RcppSCPCM4Grid, 20},

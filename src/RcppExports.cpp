...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type dist_average(dist_averageSEXP);
    Rcpp::traits::input_parameter< bool >::type progressbar(progressbarSEXP);
    rcpp_result_gen = Rcpp::wrap(RcppSCPCM4Grid(xMatrix, yMatrix, zMatrix, libsizes, lib, pred, E, tau, b, simplex, theta, threads, parallel_level, cumulate, style, dist_metric, dist_average, progressbar));
    return rcpp_result_gen;
END_RCPP
}
// RcppGCMC4Grid
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type dist_average(dist_averageSEXP);
    Rcpp::traits::input_parameter< bool >::type progressbar(progressbarSEXP);
    rcpp_result_gen = Rcpp::wrap(RcppSCPCM4Lattice(x, y, z, nb, libsizes, lib, pred, E, tau, b, simplex, theta, threads, parallel_level, cumulate, style, dist_metric, dist_average, progressbar));
    return rcpp_result_gen;
END_RCPP
}
// RcppGCMC4Lattice

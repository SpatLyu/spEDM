...
## spatial (granger) causality test
## pre -> npp: statistic = 0.27, p value = 0
## npp -> pre: statistic = 0.168, p value = 0

# temperature and npp
sc.test(npp,"tem","npp",k = 30)
## spatial (granger) causality test
## tem -> npp: statistic = 0.064, p value = 0
## npp -> tem: statistic = 0.099, p value = 0

# precipitation and temperature
sc.test(npp,"pre","tem",k = 30)
## spatial (granger) causality test
## pre -> tem: statistic = 0.093, p value = 0
## tem -> pre: statistic = 0.082, p value = 0
```

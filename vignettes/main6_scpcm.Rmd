...
Since the self-prediction performance of the y variable is relatively weaker than that of x and z, we select the embedding dimension that yields the strongest predictive performance for
y as the final dimension used in the SCPCM analysis, that is $E = 9$.
...
Computing: [====================                    ] 50%  (~2s remaining)       
Computing: [==========================              ] 63%  (~1s remaining)       
Computing: [==============================          ] 75%  (~1s remaining)       
Computing: [========================================] 100% (done)                         
## 
Computing: [==========                              ] 25%  (~3s remaining)       
Computing: [====================                    ] 50%  (~2s remaining)       
Computing: [==========================              ] 63%  (~1s remaining)       
Computing: [====================================    ] 88%  (~0s remaining)       
Computing: [========================================] 100% (done)
xz
## -------------------------------------- 
## ***partial cross mapping prediction*** 

...
``` r
s1 = spEDM::simplex(species, "x", "x", E = 5:13, k = 15, tau = 1)
s2 = spEDM::simplex(species, "y", "y", E = 5:13, k = 15, tau = 1)
s3 = spEDM::simplex(species, "z", "z", E = 5:13, k = 15, tau = 1)
list(s1,s2,s3)
## [[1]]
...
Since the self-prediction performance of the y variable is relatively weaker than that of x and z, we select the embedding dimension that yields relatively stable and fairly good predictive performance for y as the final dimension, that is $E = 12$.

Investigate the causation between x and z, with y as control variables:


``` r
xz = spEDM::scpcm(species, "x", "z", "y", E = 12, k = 15,
...
## -------------------------------------- 
##   libsizes       x->z      z->x
## 1       50 0.07012948 0.1280262
## 2      100 0.06351926 0.1825078
## 3      150 0.09457390 0.2199306
## 4      200 0.14493017 0.2588202
## 5      250 0.18167778 0.2807256
## 6      300 0.19455661 0.3043906
## 7      350 0.19592172 0.3433233
## 8      400 0.17315840 0.3544498
## 
## ------------------------------ 
## ***cross mapping prediction*** 
## ------------------------------ 
##   libsizes      x->z      z->x
## 1       50 0.1467021 0.1496570
## 2      100 0.1790469 0.2216212
## 3      150 0.2273195 0.2867529
## 4      200 0.2965731 0.3530164
## 5      250 0.3625390 0.4143833
## 6      300 0.4227430 0.4717368
## 7      350 0.4717804 0.5382956
## 8      400 0.5104943 0.5830210
```

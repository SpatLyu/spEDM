...
``` r
startTime = Sys.time()
sp_res = gccm(cause = "ntl",
              effect = "cu",
              data = soilpollution,
              libsizes = seq(10,120,20),
              E = 3, RowCol = pred)
## Computing: [=======                                 ] 17%  (~3m23s remaining)       Computing: [==============                          ] 33%  (~4m4s remaining)       Computing: [====================                    ] 50%  (~3m28s remaining)       Computing: [===========================             ] 67%  (~1m57s remaining)       Computing: [==================================      ] 83%  (~47s remaining)       Computing: [========================================] 100% (done)                         
## Computing: [=======                                 ] 17%  (~2m56s remaining)       Computing: [==============                          ] 33%  (~3m35s remaining)       Computing: [====================                    ] 50%  (~3m4s remaining)       Computing: [===========================             ] 67%  (~1m48s remaining)       Computing: [==================================      ] 83%  (~43s remaining)       Computing: [========================================] 100% (done)
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 8.381297 mins
sp_res
##   lib_sizes x_xmap_y_mean x_xmap_y_sig x_xmap_y_upper x_xmap_y_lower y_xmap_x_mean
## 1        10    0.03479201 3.758405e-01      0.1113960    -0.04222296    0.02554708
## 2        30    0.12246878 1.759246e-03      0.1975106     0.04600001    0.07388129
## 3        50    0.20367775 1.625105e-07      0.2762527     0.12879306    0.11688379
## 4        70    0.24407653 2.856015e-10      0.3150648     0.17037242    0.14388369
## 5        90    0.29381954 2.087219e-14      0.3625301     0.22193217    0.19071174
## 6       110    0.46495562 0.000000e+00      0.5231518     0.40244339    0.23136933
##   y_xmap_x_sig y_xmap_x_upper y_xmap_x_lower
## 1 5.155774e-01      0.1022482   -0.051456012
## 2 5.976021e-02      0.1499314   -0.003037965
## 3 2.840761e-03      0.1920594    0.040344435
## 4 2.328362e-04      0.2183694    0.067731129
## 5 9.687684e-07      0.2637456    0.115503737
## 6 2.392951e-09      0.3028822    0.157265523
```
...
![**Figure 3**. The cross-mapping prediction outputs between soil Cu and nightlight.](man/figures/gccm/fig3-1.png)

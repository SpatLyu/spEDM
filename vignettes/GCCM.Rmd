...
popd = readr::read_csv(system.file("extdata/popdensity.csv", 
                                   package = "spEDM"))
popd
```
...
```{r gccm_plot, fig.width=6.25,fig.height=4.55,fig.dpi=300}
windowsFonts(TNR = windowsFont("Times New Roman"))

fig_gccm = ggplot2::ggplot(data = res,
                           ggplot2::aes(x = lib_sizes)) +
  ggplot2::geom_line(ggplot2::aes(y = x_xmap_y,
                                  color = "x xmap y"),
                      lwd = 1.25) +
  ggplot2::geom_line(ggplot2::aes(y = y_xmap_x,
                                  color = "y xmap x"),
                     lwd = 1.25) +

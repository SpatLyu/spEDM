...
Computing: [===                                     ] 7%  (~18m46s remaining)       
Computing: [=====                                   ] 11%  (~14m33s remaining)       
Computing: [======                                  ] 14%  (~13m13s remaining)       
Computing: [========                                ] 18%  (~10m38s remaining)       
Computing: [=========                               ] 21%  (~8m58s remaining)       
Computing: [==========                              ] 25%  (~8m16s remaining)       
Computing: [============                            ] 29%  (~7m35s remaining)       
Computing: [=============                           ] 32%  (~6m38s remaining)       
Computing: [===============                         ] 36%  (~6m5s remaining)       
Computing: [================                        ] 39%  (~5m34s remaining)       
Computing: [==================                      ] 43%  (~4m49s remaining)       
Computing: [===================                     ] 46%  (~5m12s remaining)       
Computing: [====================                    ] 50%  (~4m45s remaining)       
Computing: [======================                  ] 54%  (~4m19s remaining)       
Computing: [=======================                 ] 57%  (~3m45s remaining)       
Computing: [=========================               ] 61%  (~3m21s remaining)       
...
Computing: [========================================] 100% (done)                         
## 
Computing: [==                                      ] 4%  (~28m16s remaining)       
Computing: [===                                     ] 7%  (~19m1s remaining)       
Computing: [=====                                   ] 11%  (~14m44s remaining)       
Computing: [======                                  ] 14%  (~13m16s remaining)       
Computing: [========                                ] 18%  (~10m42s remaining)       
Computing: [=========                               ] 21%  (~9m3s remaining)       
Computing: [==========                              ] 25%  (~8m20s remaining)       
Computing: [============                            ] 29%  (~7m41s remaining)       
Computing: [=============                           ] 32%  (~6m41s remaining)       
Computing: [===============                         ] 36%  (~6m8s remaining)       
Computing: [================                        ] 39%  (~5m38s remaining)       
Computing: [==================                      ] 43%  (~4m52s remaining)       
Computing: [===================                     ] 46%  (~5m14s remaining)       
Computing: [====================                    ] 50%  (~4m38s remaining)       
Computing: [======================                  ] 54%  (~4m16s remaining)       
Computing: [=======================                 ] 57%  (~3m47s remaining)       
Computing: [=========================               ] 61%  (~3m18s remaining)       
Computing: [==========================              ] 64%  (~2m57s remaining)       
...
## Time difference of 20.804 mins
pd_res
...
*To save the computation time, we aggregate the npp raster data by `4` times*


``` r
npp = terra::aggregate(npp,4)
```


``` r
predRows = seq(5,terra::nrow(npp),5)
predCols = seq(5,terra::ncol(npp),5)
...
npp_res = gccm(cause = "pre",
               effect = "npp",
               data = npp,
               libsizes = seq(10,120,10),
               E = 3,
               RowCol = pred,
               trendRM = FALSE)
## 
Computing: [========================                ] 58%  (~4s remaining)       
Computing: [===========================             ] 67%  (~4s remaining)       
Computing: [==============================          ] 75%  (~3s remaining)       
Computing: [==================================      ] 83%  (~1s remaining)       
Computing: [=====================================   ] 92%  (~0s remaining)       
Computing: [========================================] 100% (done)                         
## 
Computing: [========================                ] 58%  (~4s remaining)       
Computing: [===========================             ] 67%  (~4s remaining)       
...
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 0.3444141 mins
npp_res
##   lib_sizes x_xmap_y_mean x_xmap_y_sig x_xmap_y_upper x_xmap_y_lower y_xmap_x_mean
## 1        10     0.3367834            0      0.4033417      0.2666803     0.3541618
## 2        20     0.3736504            0      0.4380641      0.3054194     0.4429641
## 3        30     0.4603036            0      0.5189268      0.3973709     0.4958022
## 4        40     0.5031373            0      0.5585144      0.4432952     0.4860145
## 5        50     0.5209342            0      0.5748888      0.4624691     0.4227845
## 6        60     0.5207866            0      0.5747531      0.4623098     0.4895783
##   y_xmap_x_sig y_xmap_x_upper y_xmap_x_lower
## 1            0      0.4197331      0.2849130
## 2            0      0.5028295      0.3788695
## 3            0      0.5517530      0.4354085
## 4            0      0.5427194      0.4248991
## 5            0      0.4840432      0.3574020
## 6            0      0.5460102      0.4287238
```

...
res = gccm(cause = "Pre",
           ...
           E = 3)
## 
Computing: [==                                      ] 4%  (~27m30s remaining)       
Computing: [===                                     ] 7%  (~18m23s remaining)       
Computing: [=====                                   ] 11%  (~14m46s remaining)       
Computing: [======                                  ] 14%  (~13m13s remaining)       
Computing: [========                                ] 18%  (~10m23s remaining)       
Computing: [=========                               ] 21%  (~9m1s remaining)       
Computing: [==========                              ] 25%  (~8m23s remaining)       
Computing: [============                            ] 29%  (~7m27s remaining)       
Computing: [=============                           ] 32%  (~6m42s remaining)       
Computing: [===============                         ] 36%  (~6m6s remaining)       
Computing: [================                        ] 39%  (~5m37s remaining)       
Computing: [==================                      ] 43%  (~4m52s remaining)       
Computing: [===================                     ] 46%  (~5m10s remaining)       
Computing: [====================                    ] 50%  (~4m34s remaining)       
Computing: [======================                  ] 54%  (~4m11s remaining)       
Computing: [=======================                 ] 57%  (~3m45s remaining)       
Computing: [=========================               ] 61%  (~3m20s remaining)       
...
Computing: [========================================] 100% (done)                         
## 
Computing: [==                                      ] 4%  (~27m12s remaining)       
Computing: [===                                     ] 7%  (~18m20s remaining)       
Computing: [=====                                   ] 11%  (~14m43s remaining)       
Computing: [======                                  ] 14%  (~13m7s remaining)       
Computing: [========                                ] 18%  (~10m22s remaining)       
Computing: [=========                               ] 21%  (~8m55s remaining)       
Computing: [==========                              ] 25%  (~8m19s remaining)       
Computing: [============                            ] 29%  (~7m27s remaining)       
Computing: [=============                           ] 32%  (~6m40s remaining)       
Computing: [===============                         ] 36%  (~6m5s remaining)       
Computing: [================                        ] 39%  (~5m37s remaining)       
Computing: [==================                      ] 43%  (~4m53s remaining)       
Computing: [===================                     ] 46%  (~5m11s remaining)       
...
Computing: [=================================       ] 82%  (~1m28s remaining)       
Computing: [===================================     ] 86%  (~1m12s remaining)       
Computing: [====================================    ] 89%  (~1m6s remaining)       
Computing: [======================================  ] 93%  (~45s remaining)       
Computing: [======================================= ] 96%  (~21s remaining)       
Computing: [========================================] 100% (done)
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 20.41797 mins
res
## # A tibble: 28 × 9
##    lib_sizes x_xmap_y_mean x_xmap_y_sig x_xmap_y_upper x_xmap_y_lower y_xmap_x_mean
##        <dbl>         <dbl>        <dbl>          <dbl>          <dbl>         <dbl>
##  1        10        0.0113     5.49e- 1         0.0483       -0.0257         0.0661
##  2       110        0.0331     7.99e- 2         0.0700       -0.00394        0.227 
##  3       210        0.0482     1.06e- 2         0.0851        0.0112         0.282 
##  4       310        0.0648     5.98e- 4         0.102         0.0278         0.308 
##  5       410        0.0792     2.66e- 5         0.116         0.0423         0.331 
##  6       510        0.0943     5.63e- 7         0.131         0.0575         0.362 
##  7       610        0.110      6.02e- 9         0.146         0.0728         0.397 
##  8       710        0.122      7.50e-11         0.159         0.0859         0.423 
##  9       810        0.136      4.78e-13         0.172         0.0994         0.442 
## 10       910        0.148      3.77e-15         0.184         0.111          0.457 
## # ℹ 18 more rows

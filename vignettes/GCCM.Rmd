...
Computing: [===                                     ] 7%  (~18m58s remaining)       
Computing: [=====                                   ] 11%  (~14m36s remaining)       
Computing: [======                                  ] 14%  (~13m18s remaining)       
Computing: [========                                ] 18%  (~10m41s remaining)       
Computing: [=========                               ] 21%  (~9m5s remaining)       
Computing: [==========                              ] 25%  (~8m26s remaining)       
...
Computing: [===================                     ] 46%  (~5m23s remaining)       
Computing: [====================                    ] 50%  (~4m49s remaining)       
Computing: [======================                  ] 54%  (~4m24s remaining)       
Computing: [=======================                 ] 57%  (~3m53s remaining)       
Computing: [=========================               ] 61%  (~3m27s remaining)       
...
Computing: [========================================] 100% (done)                         
## 
Computing: [==                                      ] 4%  (~27m42s remaining)       
Computing: [===                                     ] 7%  (~18m31s remaining)       
Computing: [=====                                   ] 11%  (~14m20s remaining)       
Computing: [======                                  ] 14%  (~13m6s remaining)       
Computing: [========                                ] 18%  (~10m30s remaining)       
Computing: [=========                               ] 21%  (~8m55s remaining)       
Computing: [==========                              ] 25%  (~8m16s remaining)       
Computing: [============                            ] 29%  (~7m31s remaining)       
Computing: [=============                           ] 32%  (~6m36s remaining)       
Computing: [===============                         ] 36%  (~6m3s remaining)       
Computing: [================                        ] 39%  (~5m29s remaining)       
Computing: [==================                      ] 43%  (~4m47s remaining)       
Computing: [===================                     ] 46%  (~5m9s remaining)       
Computing: [====================                    ] 50%  (~4m36s remaining)       
Computing: [======================                  ] 54%  (~4m12s remaining)       
Computing: [=======================                 ] 57%  (~3m43s remaining)       
Computing: [=========================               ] 61%  (~3m19s remaining)       
Computing: [==========================              ] 64%  (~2m55s remaining)       
Computing: [============================            ] 68%  (~2m37s remaining)       
Computing: [=============================           ] 71%  (~2m14s remaining)       
Computing: [==============================          ] 75%  (~2m5s remaining)       
Computing: [================================        ] 79%  (~1m49s remaining)       
Computing: [=================================       ] 82%  (~1m27s remaining)       
...
## Time difference of 20.70491 mins
res
## # A tibble: 28 × 9
##    lib_sizes x_xmap_y_mean x_xmap_y_sig x_xmap_y_upper x_xmap_y_lower y_xmap_x_mean
##        <dbl>         <dbl>        <dbl>          <dbl>          <dbl>         <dbl>
##  1        10       0.00379      0.841           0.0408       -0.0332         0.0210
##  2       110       0.00913      0.629           0.0461       -0.0279         0.130 
##  3       210       0.0152       0.420           0.0522       -0.0218         0.182 
##  4       310       0.0215       0.256           0.0584       -0.0156         0.211 
##  5       410       0.0276       0.144           0.0645       -0.00942        0.235 
##  6       510       0.0331       0.0796          0.0700       -0.00391        0.255 
##  7       610       0.0381       0.0436          0.0750        0.00110        0.275 
##  8       710       0.0423       0.0249          0.0792        0.00534        0.297 
##  9       810       0.0464       0.0139          0.0833        0.00946        0.317 
## 10       910       0.0499       0.00820         0.0867        0.0129         0.334 
## # ℹ 18 more rows

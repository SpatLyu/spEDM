...
Computing: [===                                     ] 7%  (~19m25s remaining)       
Computing: [=====                                   ] 11%  (~15m3s remaining)       
Computing: [======                                  ] 14%  (~13m35s remaining)       
Computing: [========                                ] 18%  (~10m52s remaining)       
Computing: [=========                               ] 21%  (~9m19s remaining)       
Computing: [==========                              ] 25%  (~8m37s remaining)       
Computing: [============                            ] 29%  (~7m58s remaining)       
Computing: [=============                           ] 32%  (~6m55s remaining)       
Computing: [===============                         ] 36%  (~6m25s remaining)       
Computing: [================                        ] 39%  (~5m54s remaining)       
Computing: [==================                      ] 43%  (~5m8s remaining)       
Computing: [===================                     ] 46%  (~5m30s remaining)       
Computing: [====================                    ] 50%  (~4m47s remaining)       
Computing: [======================                  ] 54%  (~4m23s remaining)       
Computing: [=======================                 ] 57%  (~4m0s remaining)       
Computing: [=========================               ] 61%  (~3m30s remaining)       
Computing: [==========================              ] 64%  (~3m7s remaining)       
Computing: [============================            ] 68%  (~2m49s remaining)       
Computing: [=============================           ] 71%  (~2m24s remaining)       
Computing: [==============================          ] 75%  (~2m15s remaining)       
Computing: [================================        ] 79%  (~1m58s remaining)       
Computing: [=================================       ] 82%  (~1m34s remaining)       
Computing: [===================================     ] 86%  (~1m16s remaining)       
Computing: [====================================    ] 89%  (~1m11s remaining)       
Computing: [======================================  ] 93%  (~47s remaining)       
Computing: [======================================= ] 96%  (~23s remaining)       
Computing: [========================================] 100% (done)                         
## 
Computing: [==                                      ] 4%  (~28m58s remaining)       
Computing: [===                                     ] 7%  (~19m20s remaining)       
Computing: [=====                                   ] 11%  (~14m58s remaining)       
Computing: [======                                  ] 14%  (~13m41s remaining)       
Computing: [========                                ] 18%  (~11m0s remaining)       
Computing: [=========                               ] 21%  (~9m17s remaining)       
Computing: [==========                              ] 25%  (~8m34s remaining)       
Computing: [============                            ] 29%  (~7m51s remaining)       
Computing: [=============                           ] 32%  (~6m50s remaining)       
Computing: [===============                         ] 36%  (~6m17s remaining)       
Computing: [================                        ] 39%  (~5m44s remaining)       
Computing: [==================                      ] 43%  (~5m0s remaining)       
Computing: [===================                     ] 46%  (~5m21s remaining)       
Computing: [====================                    ] 50%  (~4m39s remaining)       
Computing: [======================                  ] 54%  (~4m16s remaining)       
Computing: [=======================                 ] 57%  (~3m51s remaining)       
Computing: [=========================               ] 61%  (~3m23s remaining)       
Computing: [==========================              ] 64%  (~3m1s remaining)       
Computing: [============================            ] 68%  (~2m43s remaining)       
Computing: [=============================           ] 71%  (~2m18s remaining)       
Computing: [==============================          ] 75%  (~2m9s remaining)       
...
## Time difference of 0.3534139 hours
res
## # A tibble: 28 × 9
##    lib_sizes x_xmap_y_mean x_xmap_y_sig x_xmap_y_upper x_xmap_y_lower y_xmap_x_mean
##        <dbl>         <dbl>        <dbl>          <dbl>          <dbl>         <dbl>
##  1        10        0.0582     2.02e- 3         0.0950         0.0213        0.0115
##  2       110        0.0974     2.33e- 7         0.134          0.0606        0.0686
##  3       210        0.142      4.35e-14         0.178          0.105         0.108 
##  4       310        0.184      0                0.220          0.148         0.138 
##  5       410        0.222      0                0.257          0.187         0.164 
##  6       510        0.255      0                0.290          0.220         0.191 
##  7       610        0.279      0                0.313          0.245         0.218 
##  8       710        0.295      0                0.329          0.261         0.243 
##  9       810        0.308      0                0.341          0.274         0.266 
## 10       910        0.320      0                0.353          0.286         0.286 
## # ℹ 18 more rows

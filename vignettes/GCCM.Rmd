...
## Time difference of 22.22306 mins
pd_res
...
``` r
simplex(npp,"pre",nnaindice,nnaindice,k = 8)
## The suggested embedding dimension E for variable pre is 2
##        E       rho      mae     rmse
##  [1,]  1 0.9986822 177.2353 247.7597
##  [2,]  2 0.9990542 142.9373 209.8525
##  [3,]  3 0.9989947 146.8244 216.7058
##  [4,]  4 0.9988843 155.5419 228.4578
##  [5,]  5 0.9987501 166.1402 241.7503
##  [6,]  6 0.9986065 177.5328 255.3343
##  [7,]  7 0.9985375 181.9100 261.4156
##  [8,]  8 0.9984485 189.0341 269.3130
##  [9,]  9 0.9983863 192.9706 274.6716
## [10,] 10 0.9982880 198.7309 283.0404
```


``` r
simplex(npp,"npp",nnaindice,nnaindice,k = 8)
## The suggested embedding dimension E for variable npp is 2
##        E       rho      mae     rmse
##  [1,]  1 0.9646361 421.1264 631.9305
##  [2,]  2 0.9697691 377.6247 582.8577
##  [3,]  3 0.9669591 364.4588 610.7955
##  [4,]  4 0.9676491 354.1172 603.7429
##  [5,]  5 0.9677260 357.5205 602.7438
##  [6,]  6 0.9651462 359.9642 626.4934
##  [7,]  7 0.9681853 356.1901 597.2504
##  [8,]  8 0.9671941 361.1308 606.3268
##  [9,]  9 0.9665862 366.8357 611.8506
## [10,] 10 0.9667007 367.2202 610.7939
```
...
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 25.28639 mins
npp_res
##    libsizes   npp->pre   pre->npp
## 1        10 0.05740000 0.06653809
## 2        15 0.06593626 0.08012391
## 3        20 0.08400060 0.11441672
## 4        25 0.10460948 0.13401015
## 5        30 0.11916766 0.15201758
## 6        35 0.12875745 0.16187685
## 7        40 0.13431273 0.17497419
## 8        45 0.14618055 0.20029010
## 9        50 0.16535551 0.23093965
## 10       55 0.19262572 0.25101785
## 11       60 0.21566290 0.25707437
## 12       65 0.23555554 0.24606888
## 13       70 0.23571425 0.23038831
## 14       75 0.21680170 0.20847992
## 15       80 0.20202568 0.21112107
## 16       85 0.14080027 0.22734529
## 17       90 0.13585590 0.25920863
## 18       95 0.10754714 0.28377246
## 19      100 0.10447653 0.26996791
## 20      105 0.08238034 0.32737051
```

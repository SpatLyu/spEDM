...
pd_res = gccm(cause = "Pre",
              ...
              trendRM = TRUE)
## 
Computing: [==                                      ] 4%  (~32m8s remaining)       
Computing: [===                                     ] 7%  (~21m13s remaining)       
Computing: [=====                                   ] 11%  (~15m16s remaining)       
Computing: [======                                  ] 14%  (~13m39s remaining)       
Computing: [========                                ] 18%  (~11m34s remaining)       
Computing: [=========                               ] 21%  (~9m15s remaining)       
Computing: [==========                              ] 25%  (~8m30s remaining)       
Computing: [============                            ] 29%  (~8m6s remaining)       
Computing: [=============                           ] 32%  (~7m7s remaining)       
Computing: [===============                         ] 36%  (~6m30s remaining)       
Computing: [================                        ] 39%  (~5m42s remaining)       
Computing: [==================                      ] 43%  (~4m55s remaining)       
Computing: [===================                     ] 46%  (~5m8s remaining)       
Computing: [====================                    ] 50%  (~4m34s remaining)       
Computing: [======================                  ] 54%  (~4m5s remaining)       
Computing: [=======================                 ] 57%  (~3m44s remaining)       
Computing: [=========================               ] 61%  (~3m16s remaining)       
Computing: [==========================              ] 64%  (~3m9s remaining)       
Computing: [============================            ] 68%  (~2m41s remaining)       
Computing: [=============================           ] 71%  (~2m17s remaining)       
Computing: [==============================          ] 75%  (~2m11s remaining)       
Computing: [================================        ] 79%  (~1m55s remaining)       
Computing: [=================================       ] 82%  (~1m32s remaining)       
...
Computing: [========================================] 100% (done)                         
## 
Computing: [==                                      ] 4%  (~28m25s remaining)       
Computing: [===                                     ] 7%  (~19m2s remaining)       
Computing: [=====                                   ] 11%  (~14m32s remaining)       
Computing: [======                                  ] 14%  (~13m4s remaining)       
Computing: [========                                ] 18%  (~10m46s remaining)       
Computing: [=========                               ] 21%  (~8m53s remaining)       
Computing: [==========                              ] 25%  (~8m15s remaining)       
Computing: [============                            ] 29%  (~7m41s remaining)       
Computing: [=============                           ] 32%  (~6m41s remaining)       
Computing: [===============                         ] 36%  (~6m9s remaining)       
Computing: [================                        ] 39%  (~5m35s remaining)       
Computing: [==================                      ] 43%  (~4m51s remaining)       
Computing: [===================                     ] 46%  (~5m7s remaining)       
Computing: [====================                    ] 50%  (~4m28s remaining)       
Computing: [======================                  ] 54%  (~4m0s remaining)       
Computing: [=======================                 ] 57%  (~3m39s remaining)       
Computing: [=========================               ] 61%  (~3m12s remaining)       
Computing: [==========================              ] 64%  (~3m4s remaining)       
...
## Time difference of 19.53462 mins
pd_res
...
npp
## class       : SpatRaster 
## dimensions  : 552, 484, 3  (nrow, ncol, nlyr)
## resolution  : 10000, 10000  (x, y)
## extent      : -2625763, 2214237, 407078.2, 5927078  (xmin, xmax, ymin, ymax)
...
*To save the computation time, we select some pixels to predict*


``` r
predRows = seq(10,terra::nrow(npp),10)
predCols = seq(10,terra::ncol(npp),10)
...
npp_res = gccm(cause = "pre",
               ...
               trendRM = TRUE)
## 
Computing: [===                                     ] 7%  (~17m10s remaining)       
Computing: [======                                  ] 13%  (~9m12s remaining)       
Computing: [========                                ] 20%  (~6m35s remaining)       
Computing: [===========                             ] 27%  (~5m8s remaining)       
Computing: [==============                          ] 33%  (~4m40s remaining)       
Computing: [================                        ] 40%  (~3m31s remaining)       
Computing: [===================                     ] 47%  (~2m57s remaining)       
Computing: [======================                  ] 53%  (~2m25s remaining)       
Computing: [========================                ] 60%  (~2m1s remaining)       
Computing: [===========================             ] 67%  (~1m48s remaining)       
Computing: [==============================          ] 73%  (~1m20s remaining)       
Computing: [================================        ] 80%  (~58s remaining)       
Computing: [===================================     ] 87%  (~38s remaining)       
Computing: [======================================  ] 93%  (~19s remaining)       
Computing: [========================================] 100% (done)                         
## 
Computing: [===                                     ] 7%  (~17m56s remaining)       
Computing: [======                                  ] 13%  (~9m31s remaining)       
Computing: [========                                ] 20%  (~6m40s remaining)       
Computing: [===========                             ] 27%  (~5m8s remaining)       
Computing: [==============                          ] 33%  (~4m39s remaining)       
Computing: [================                        ] 40%  (~3m30s remaining)       
Computing: [===================                     ] 47%  (~2m56s remaining)       
Computing: [======================                  ] 53%  (~2m23s remaining)       
Computing: [========================                ] 60%  (~1m57s remaining)       
Computing: [===========================             ] 67%  (~1m43s remaining)       
Computing: [==============================          ] 73%  (~1m17s remaining)       
Computing: [================================        ] 80%  (~55s remaining)       
Computing: [===================================     ] 87%  (~37s remaining)       
Computing: [======================================  ] 93%  (~18s remaining)       
Computing: [========================================] 100% (done)
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 8.771491 mins
npp_res
## [1] lib_sizes      x_xmap_y_mean  x_xmap_y_sig   x_xmap_y_upper x_xmap_y_lower y_xmap_x_mean 
## [7] y_xmap_x_sig   y_xmap_x_upper y_xmap_x_lower

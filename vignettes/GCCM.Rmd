...
## Time difference of 5.794167 mins
pd_res
...
``` r
simplex(npp,"pre",nnaindice,predindice,k = 5)
## The suggested E and k for variable pre is 4 and 5
```


``` r
simplex(npp,"npp",nnaindice,predindice,k = 5)
## The suggested E and k for variable npp is 6 and 5
```
...
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 8.968905 mins
npp_res
##    libsizes  pre->npp  npp->pre
## 1        10 0.1343689 0.1024714
## 2        20 0.2019941 0.1581908
## 3        30 0.2591501 0.2193943
## 4        40 0.3142908 0.2617983
## 5        50 0.3561954 0.2813667
## 6        60 0.4149762 0.3131397
## 7        70 0.4633459 0.3272614
## 8        80 0.4919156 0.3275292
## 9        90 0.5321070 0.3297922
## 10      100 0.5740755 0.3328955
## 11      110 0.6186982 0.3329590
## 12      120 0.6602847 0.3487243
## 13      130 0.6855226 0.3574619
## 14      140 0.6934396 0.3605239
## 15      150 0.6966200 0.3644481
## 16      160 0.6982002 0.3650070
```

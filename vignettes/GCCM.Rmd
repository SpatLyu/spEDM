...
## The optimal embedding dimension E for variable Pre is 1
##        E       rho      mae     rmse
...
## The optimal embedding dimension E for variable popDensity is 6
##        E       rho      mae     rmse
...
## Time difference of 22.21286 mins
pd_res
##    libsizes popDensity->Pre Pre->popDensity
## 1        10      0.00805187      0.04643586
## 2       110      0.01727373      0.16230318
## 3       210      0.02272118      0.22321616
## 4       310      0.02745849      0.25955866
## 5       410      0.03216842      0.29002613
## 6       510      0.03557478      0.32183303
## 7       610      0.03730005      0.35674206
## 8       710      0.03927667      0.38984504
## 9       810      0.04094269      0.41684610
## 10      910      0.04264743      0.44089219
## 11     1010      0.04479801      0.46370618
## 12     1110      0.04701311      0.48324529
## 13     1210      0.04944336      0.50262194
## 14     1310      0.05168131      0.51980920
## 15     1410      0.05351410      0.53596115
## 16     1510      0.05396816      0.55319643
## 17     1610      0.05414800      0.57263461
## 18     1710      0.05411687      0.59201939
## 19     1810      0.05444611      0.61040905
## 20     1910      0.05486435      0.62862826
## 21     2010      0.05546377      0.64642484
## 22     2110      0.05608152      0.66340019
## 23     2210      0.05642595      0.67993361
## 24     2310      0.05654404      0.69595321
## 25     2410      0.05699853      0.71162110
## 26     2510      0.05750456      0.72716922
## 27     2610      0.05813422      0.74251105
## 28     2710      0.05893608      0.75498105
```
...
``` r
simplex(npp,"pre",lib,pred,k = 8)
## The optimal embedding dimension E for variable pre is 2
##        E       rho      mae     rmse
##  [1,]  1 0.9986893 183.9074 251.8857
##  [2,]  2 0.9989867 153.1760 220.8124
##  [3,]  3 0.9987665 165.4989 243.9867
##  [4,]  4 0.9984710 183.8567 271.5982
##  [5,]  5 0.9982236 196.5187 292.6010
##  [6,]  6 0.9980173 209.4455 309.4099
##  [7,]  7 0.9978050 217.2941 325.3601
##  [8,]  8 0.9976748 227.3263 334.7036
##  [9,]  9 0.9975697 232.7360 342.2481
## [10,] 10 0.9973707 240.3327 356.1283
```


``` r
simplex(npp,"npp",lib,pred,k = 8)
## The optimal embedding dimension E for variable npp is 7
##        E       rho      mae     rmse
##  [1,]  1 0.9633140 425.8325 641.7362
##  [2,]  2 0.9678922 378.9006 598.8432
##  [3,]  3 0.9708172 361.3486 572.7524
##  [4,]  4 0.9710194 357.5127 568.4213
##  [5,]  5 0.9713380 361.2625 564.8431
##  [6,]  6 0.9706332 362.0352 572.1780
##  [7,]  7 0.9717924 364.5031 560.9212
##  [8,]  8 0.9716443 369.5046 562.6092
##  [9,]  9 0.9710155 374.0819 568.8065
## [10,] 10 0.9707681 376.5773 571.4094
```

Under the selected lib and pred, the optimal embedding dimension E for the variable `pre` is 2, and for the variable `npp`, it is 4.
...
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 26.9252 mins
npp_res
##    libsizes    npp->pre    pre->npp
## 1        10  0.06416495  0.08686229
## 2        15  0.07874713  0.11053171
## 3        20  0.08609531  0.14533013
## 4        25  0.10580122  0.17751592
## 5        30  0.11600625  0.19996579
## 6        35  0.13163121  0.23553036
## 7        40  0.13865953  0.26590562
## 8        45  0.14855229  0.31211179
## 9        50  0.16692439  0.36223075
## 10       55  0.18709534  0.36914780
## 11       60  0.19905397  0.34206742
## 12       65  0.21690957  0.29567725
## 13       70  0.20792943  0.21920355
## 14       75  0.16969755  0.13708926
## 15       80  0.15152887  0.09677873
## 16       85  0.02021065  0.18705811
## 17       90  0.02619818  0.15685076
## 18       95  0.01046558  0.16668902
## 19      100 -0.05790607  0.04389603
## 20      105 -0.07639378 -0.33499155
```

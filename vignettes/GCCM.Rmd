...
pd_res = gccm(cause = "Pre",
              ...
              E = 3, nb = popd_nb)
## 
Computing: [==                                      ] 4%  (~28m12s remaining)       
Computing: [===                                     ] 7%  (~19m2s remaining)       
Computing: [=====                                   ] 11%  (~14m48s remaining)       
Computing: [======                                  ] 14%  (~13m17s remaining)       
Computing: [========                                ] 18%  (~10m40s remaining)       
Computing: [=========                               ] 21%  (~9m2s remaining)       
Computing: [==========                              ] 25%  (~8m22s remaining)       
Computing: [============                            ] 29%  (~7m42s remaining)       
Computing: [=============                           ] 32%  (~6m41s remaining)       
Computing: [===============                         ] 36%  (~6m11s remaining)       
Computing: [================                        ] 39%  (~5m40s remaining)       
Computing: [==================                      ] 43%  (~4m55s remaining)       
Computing: [===================                     ] 46%  (~5m7s remaining)       
Computing: [====================                    ] 50%  (~4m32s remaining)       
Computing: [======================                  ] 54%  (~4m3s remaining)       
Computing: [=======================                 ] 57%  (~3m44s remaining)       
Computing: [=========================               ] 61%  (~3m15s remaining)       
Computing: [==========================              ] 64%  (~2m58s remaining)       
Computing: [============================            ] 68%  (~2m41s remaining)       
...
Computing: [========================================] 100% (done)                         
## 
Computing: [==                                      ] 4%  (~28m1s remaining)       
Computing: [===                                     ] 7%  (~19m6s remaining)       
Computing: [=====                                   ] 11%  (~14m49s remaining)       
Computing: [======                                  ] 14%  (~13m24s remaining)       
Computing: [========                                ] 18%  (~10m41s remaining)       
Computing: [=========                               ] 21%  (~9m5s remaining)       
Computing: [==========                              ] 25%  (~8m23s remaining)       
Computing: [============                            ] 29%  (~7m45s remaining)       
Computing: [=============                           ] 32%  (~6m44s remaining)       
Computing: [===============                         ] 36%  (~6m14s remaining)       
Computing: [================                        ] 39%  (~5m41s remaining)       
Computing: [==================                      ] 43%  (~4m57s remaining)       
Computing: [===================                     ] 46%  (~5m7s remaining)       
Computing: [====================                    ] 50%  (~4m34s remaining)       
Computing: [======================                  ] 54%  (~4m5s remaining)       
...
## Time difference of 19.65577 mins
pd_res
...
### 2.3 An example of grid data about soil pollution

Load data and package:


``` r
soilpollution = terra::rast(system.file("extdata/soilpollution.tif",
                                        package = "spEDM"))
soilpollution
## class       : SpatRaster 
...
![**Figure 2**. Maps of soil Cu concentration, the density of industrial pollutants and nightlight.](../man/figures/gccm/fig2-1.png)

To save the computation time, not every pixels are predict and the results are almost the same due to the spatial autocorrealtion.


``` r
predRows = seq(5,terra::nrow(soilpollution),5)
predCols = seq(5,terra::ncol(soilpollution),5)
pred = as.matrix(merge(predRows,predCols))
```
...
``` r
startTime = Sys.time()
sp_res = gccm(cause = "industry",
              effect = "cu",
              data = soilpollution,
              libsizes = seq(10,120,20),
              E = 3,
              RowCol = pred,
              trendRM = FALSE)
## 
Computing: [=======                                 ] 17%  (~3m25s remaining)       
Computing: [==============                          ] 33%  (~4m6s remaining)       
Computing: [====================                    ] 50%  (~3m22s remaining)       
Computing: [===========================             ] 67%  (~1m59s remaining)       
Computing: [==================================      ] 83%  (~48s remaining)       
Computing: [========================================] 100% (done)                         
## 
Computing: [=======                                 ] 17%  (~3m36s remaining)       
Computing: [==============                          ] 33%  (~4m14s remaining)       
Computing: [====================                    ] 50%  (~3m32s remaining)       
Computing: [===========================             ] 67%  (~2m4s remaining)       
Computing: [==================================      ] 83%  (~50s remaining)       
Computing: [========================================] 100% (done)
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 8.945175 mins
sp_res
##   lib_sizes x_xmap_y_mean x_xmap_y_sig x_xmap_y_upper x_xmap_y_lower y_xmap_x_mean
## 1        10    0.06789903 8.367371e-02      0.1440489   -0.009050227    0.06470362
## 2        30    0.16248160 3.151964e-05      0.2364294    0.086662461    0.18094579
## 3        50    0.29765803 9.103829e-15      0.3661780    0.225927631    0.31948773
## 4        70    0.39853941 0.000000e+00      0.4613032    0.331806790    0.36728437
## 5        90    0.45826155 0.000000e+00      0.5169457    0.395290059    0.45694910
## 6       110    0.59279562 0.000000e+00      0.6404991    0.540535082    0.61505957
##   y_xmap_x_sig y_xmap_x_upper y_xmap_x_lower
## 1 9.931630e-02      0.1409045    -0.01225938
## 2 3.438391e-06      0.2543091     0.10551201
## 3 0.000000e+00      0.3868843     0.24869601
## 4 0.000000e+00      0.4319850     0.29882259
## 5 0.000000e+00      0.5157283     0.39388846
## 6 0.000000e+00      0.6607104     0.56487581
```
...
``` r
fig3 = ggplot2::ggplot(data = sp_res,
                       ggplot2::aes(x = lib_sizes)) +
  ggplot2::geom_line(ggplot2::aes(y = x_xmap_y_mean,
                                  color = "x xmap y"),
                      lwd = 1.25) +
...
![**Figure 3**. The cross-mapping prediction outputs between population density and county-level Precipitation.](../man/figures/gccm/fig3-1.png)

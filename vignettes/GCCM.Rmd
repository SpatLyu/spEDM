...
## Warning in spdep::read.gal(system.file("case/popdensity_nb.gal", package =
...
## Delimiter: ","
## dbl (7): x, y, popdensity, elev, tem, pre, slope
## 
## ℹ Use `spec()` to retrieve the full column specification for this data.
## ℹ Specify the column types or set `show_col_types = FALSE` to quiet this message.
popdensity
## # A tibble: 2,806 × 7
##        x     y popdensity  elev   tem   pre slope
...
## Geodetic CRS:  WGS 84
## # A tibble: 2,806 × 6
##    popdensity  elev   tem   pre slope          geometry
...
## Time difference of 5.744986 mins
pd_res
...
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 9.407058 mins
npp_res

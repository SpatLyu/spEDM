...
res = gccm(cause = "Pre",
           ...
           E = 3)
## 
Computing: [==                                      ] 4%  (~27m37s remaining)       
Computing: [===                                     ] 7%  (~18m55s remaining)       
Computing: [=====                                   ] 11%  (~14m44s remaining)       
Computing: [======                                  ] 14%  (~13m15s remaining)       
Computing: [========                                ] 18%  (~10m28s remaining)       
Computing: [=========                               ] 21%  (~9m0s remaining)       
...
## Time difference of 0.3444497 hours
res
## # A tibble: 28 × 9
##    lib_sizes x_xmap_y_mean x_xmap_y_sig x_xmap_y_upper x_xmap_y_lower y_xmap_x_mean
##        <dbl>         <dbl>        <dbl>          <dbl>          <dbl>         <dbl>
##  1        10       0.00118       0.950          0.0382      -0.0358         0.00744
##  2       110       0.00632       0.738          0.0433      -0.0307         0.0401 
##  3       210       0.0132        0.485          0.0502      -0.0238         0.0575 
##  4       310       0.0195        0.302          0.0565      -0.0175         0.0785 
##  5       410       0.0260        0.168          0.0629      -0.0110         0.101  
##  6       510       0.0320        0.0902         0.0689      -0.00502        0.115  
##  7       610       0.0373        0.0483         0.0742       0.000272       0.129  
##  8       710       0.0416        0.0276         0.0785       0.00459        0.142  
##  9       810       0.0454        0.0161         0.0823       0.00844        0.154  
## 10       910       0.0483        0.0105         0.0851       0.0113         0.163  
## # ℹ 18 more rows

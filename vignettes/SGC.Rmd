---
title: "Spatial Granger Causality Test (SGC)"
author: "Wenbo Lv"
date: "2025-05-16"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{SGC}
...
Use spatial granger causality test to detect spatial causality among the variables *inc*, *crime*, and *hoval* :
...
Use spatial granger causality test to detect spatial causality among the variables *pre*, *tem*, and *npp* :


``` r
# precipitation and npp
sgc(npp,"pre","npp",k = 30)
## spatial granger causality test
## pre -> npp: statistic = 0.189, p value = 0
## npp -> pre: statistic = 0.111, p value = 0

# temperature and npp
sgc(npp,"tem","npp",k = 30)
## spatial granger causality test
## tem -> npp: statistic = 0.063, p value = 0
## npp -> tem: statistic = 0.057, p value = 0

# precipitation and temperature
sgc(npp,"pre","tem",k = 30)
## spatial granger causality test
## pre -> tem: statistic = 0.077, p value = 0
## tem -> pre: statistic = 0.052, p value = 0
```

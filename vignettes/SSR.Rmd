...
<img src="../man/figures/ssr/fig1-1.png" alt="**Figure 1**. The reconstructed shadow manifolds for `popd`."  />
<p class="caption">**Figure 1**. The reconstructed shadow manifolds for `popd`.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="../man/figures/ssr/fig2-1.png" alt="**Figure 2**. The reconstructed shadow manifolds for `cu`."  />
<p class="caption">**Figure 2**. The reconstructed shadow manifolds for `cu`.</p>
</div>

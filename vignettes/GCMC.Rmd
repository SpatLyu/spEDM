...
## 0.46666667 0.40000000 0.13333333 0.53333333 0.40000000 0.40000000 0.46666667 
##        E:8        E:9       E:10       E:11       E:12       E:13       E:14 
## 0.40000000 0.46666667 0.40000000 0.46666667 0.40000000 0.40000000 0.26666667 
##       E:15       E:16       E:17       E:18       E:19 
## 0.13333333 0.06666667 0.00000000 0.00000000 0.00000000
```

At $E = 17$, the false nearest neighbor ratio drops to 0 and remains at 0 thereafter. Therefore, $E = 17$ is selected for the subsequent GCMC analysis.


``` r
# precipitation and npp
g1 = gcmc(npp, "pre", "npp", E = 17, k = 172, lib = predindice, pred = predindice, progressbar = FALSE)
g1
##   neighbors  pre->npp  npp->pre
## 1       172 0.2443551 0.2075446

# temperature and npp
g2 = gcmc(npp, "tem", "npp", E = 17, k = 172, lib = predindice, pred = predindice, progressbar = FALSE)
g2
##   neighbors  tem->npp  npp->tem
## 1       172 0.4307396 0.4331057

# precipitation and temperature
g3 = gcmc(npp, "pre", "tem", E = 17, k = 172, lib = predindice, pred = predindice, progressbar = FALSE)
g3
##   neighbors  pre->tem  tem->pre
## 1       172 0.3267645 0.2765684
```
...
res2
##   cause effect        ca          sig
## 1   pre    npp 0.2443551 2.177402e-17
## 2   npp    pre 0.2075446 1.634524e-25
## 3   tem    npp 0.4307396 4.852701e-02
## 4   npp    tem 0.4331057 5.757934e-02
## 5   pre    tem 0.3267645 1.641604e-07
## 6   tem    pre 0.2765684 5.939523e-13
```

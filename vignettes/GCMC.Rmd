...
g1 = gcmc(popd_sf, "tem", "popd", E = c(2,5), k = 210,
          nb = popd_nb, detrend = TRUE, progressbar = FALSE)
g1
##   neighbors tem->popd popd->tem
## 1       210 0.7536054 0.1971655

# elevation and population density
g2 = gcmc(popd_sf, "elev", "popd", E = c(1,5), k = 210,
          nb = popd_nb, detrend = TRUE, progressbar = FALSE)
g2
##   neighbors elev->popd popd->elev
## 1       210  0.8352381  0.2061451

# elevation and temperature
g3 = gcmc(popd_sf, "elev", "tem", E = c(1,2), k = 210,
          nb = popd_nb, detrend = TRUE, progressbar = FALSE)
g3
##   neighbors elev->tem tem->elev
## 1       210 0.6272562 0.5090023
```
...
res1
##   cause effect        ca          sig
## 1   tem   popd 0.7536054 1.253182e-19
## 2  popd    tem 0.1971655 3.035074e-35
## 3  elev   popd 0.8352381 1.374037e-43
## 4  popd   elev 0.2061451 4.111211e-32
## 5  elev    tem 0.6272562 4.805542e-05
## 6   tem   elev 0.5090023 7.790993e-01
```
...
g1 = gcmc(npp, "pre", "npp", E = 2, k = 270,
          lib = predindice, pred = predindice,
          detrend = TRUE, progressbar = FALSE)
g1
##   neighbors  pre->npp  npp->pre
## 1       270 0.6074486 0.5375995

# temperature and npp
g2 = gcmc(npp, "tem", "npp", E = 2, k = 270,
          lib = predindice, pred = predindice,
          detrend = TRUE, progressbar = FALSE)
g2
##   neighbors  tem->npp npp->tem
## 1       270 0.6398354 0.610631

# precipitation and temperature
g3 = gcmc(npp, "pre", "tem", E = 2, k = 270,
          lib = predindice, pred = predindice,
          detrend = TRUE, progressbar = FALSE)
g3
##   neighbors  pre->tem  tem->pre
## 1       270 0.6789575 0.6376543
```
...
res2
##   cause effect        ca          sig
## 1   pre    npp 0.6074486 1.108801e-04
## 2   npp    pre 0.5375995 1.772553e-01
## 3   tem    npp 0.6398354 2.731791e-07
## 4   npp    tem 0.6106310 5.454179e-05
## 5   pre    tem 0.6789575 1.796755e-11
## 6   tem    pre 0.6376543 4.110065e-07
```

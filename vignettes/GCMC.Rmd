...
g1 = gcmc(npp, "pre", "npp", E = 3, k = 350, lib = nnaindice, pred = predindice, progressbar = FALSE)
g1
##   neighbors  pre->npp  npp->pre
## 1       350 0.6358939 0.5521714

# temperature and npp
g2 = gcmc(npp, "tem", "npp", E = 3, k = 350, lib = nnaindice, pred = predindice, progressbar = FALSE)
g2
##   neighbors  tem->npp  npp->tem
## 1       350 0.7226041 0.7212735

# precipitation and temperature
g3 = gcmc(npp, "pre", "tem", E = 3, k = 350, lib = nnaindice, pred = predindice, progressbar = FALSE)
g3
##   neighbors  pre->tem  tem->pre
## 1       350 0.7078204 0.6440735
```
...
res2
##   cause effect        ca          sig
## 1   pre    npp 0.6358939 2.138182e-08
## 2   npp    pre 0.5521714 3.717032e-02
## 3   tem    npp 0.7226041 7.687707e-23
## 4   npp    tem 0.7212735 2.707422e-22
## 5   pre    tem 0.7078204 2.079939e-19
## 6   tem    pre 0.6440735 2.311726e-09
```
